...
const P: Record<string, React.ReactNode> = {
  ...
  chat: (
    <>
      <path d="M20.5 12.2c0 4-3.8 7.2-8.5 7.2a9.8 9.8 0 0 1-2.6-.35L4.5 20.5l1.3-3.7A6.9 6.9 0 0 1 3.5 12.2C3.5 8.2 7.3 5 12 5s8.5 3.2 8.5 7.2Z" />
      <path d="M8.7 11.9h.01M12 11.9h.01M15.3 11.9h.01" />
    </>
  ),
